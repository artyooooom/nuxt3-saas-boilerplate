        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center lg:order-2 space-x-4">
                    <a v-for="(button, i) in buttons" :key="i" class="block py-2 pr-1 rounded lg:bg-transparent lg:p-0 dark:text-white":target="button.link?.target" :href="button.link?.url">
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li v-for="link in links" :key="link.title">
                            <a class="block py-2 px-3 rounded lg:bg-transparent text-sm hover:bg-primary-foreground" :href="link.url">
                            {{ link.title }}
                            </a>
                        </li>
